...
const ContentMobile = () => {
    ...
    return (
        ...
        <div style={{background:"#91D1D3", position: "relative",  height: "100%", width:browserWidth, minHeight:"50px", flex:"1"}}>
            ...
            <div style={{fontFamily:"ParkYongJun", fontSize:"5vw", alignItems:"center", justifyContent:"center", display:"flex"}} >
            ...
            <div style={{display:"flex"}}>
                <div data-aos="flip-right" style={{ paddingBottom:"20px", paddingTop:"55px", position:"relative", zIndex:"2"}}>
                ...
                <div  data-aos="flip-left" style={{ paddingBottom:"20px", paddingTop:"55px", position:"relative", zIndex:"2"}}>
                    <div className="papeTag" style={{fontFamily:"ParkYongJun", fontSize:"30px", alignItems:"center", justifyContent:"center", display:"flex", width:"100%"}}>
            ...
            <div data-aos="flip-up" style={{display:"flex", paddingTop:"30px", justifyContent:"center", display:"flex"}}>
                <div style={{paddingBottom:"20px", paddingTop:"55px", paddingRight:"8%",position:"relative", zIndex:"2"}}>
